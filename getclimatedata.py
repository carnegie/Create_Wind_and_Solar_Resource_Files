...
#/carnegie/nobackup/scratch/Climate_Energy_Lab


def main():

    ERA5path = '/carnegie/nobackup/scratch/jdowling/CFs/ERA5'
    MERRA2path = '/carnegie/nobackup/scratch/jdowling/CFs/MERRA2'
